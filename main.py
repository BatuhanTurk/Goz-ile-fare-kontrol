...
import pyautogui as mause

mause.FAILSAFE = False
    ...
    for(x,y,w,h) in faces:
        ...
        if( goz_sayi ==2):
            ...
            if(fare_konum_x > 0 and fare_konum_x < ekranBoyut[0] and fare_konum_y >0 and fare_konum_y < ekranBoyut[1]):
                mause.moveTo(fare_konum_x,fare_konum_y)
